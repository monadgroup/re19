...
use crate::flags::{
    ...
    ImGuiInputTextFlags, ImGuiViewportFlags,
};
use crate::{ImDrawCallback, ImDrawIdx, ImGuiID, ImTextureID, ImU32, ImU64, ImVec2, ImVec4, ImWchar};

/// Font atlas glyph range builder
#[repr(C)]
pub struct ImFontGlyphRangesBuilder {
    pub used_chars: ImVector<c_int>,
}
...
pub struct ImGuiIO {
    ...
    pub config_docking_tab_bar_on_single_windows: bool,
    ...
    pub config_viewports_no_parent: bool,
    ...
    pub backend_renderer_user_data: *mut c_void,
    pub backend_language_user_data: *mut c_void,
    ...
    pub mouse_hovered_viewport: ImGuiID,
    pub key_ctrl: bool,
    pub key_shift: bool,
    pub key_alt: bool,
    pub key_super: bool,
...
pub struct ImGuiPlatformMonitor {
    pub main_pos: ImVec2,
    pub main_size: ImVec2,
    pub work_pos: ImVec2,
    pub work_size: ImVec2,
    pub dpi_scale: c_float,
}

#[repr(C)]
pub struct ImGuiPlatformIO {
    pub platform_create_window: Option<extern "C" fn(vp: *mut ImGuiViewport)>,
    pub platform_destroy_window: Option<extern "C" fn(vp: *mut ImGuiViewport)>,
    pub platform_show_window: Option<extern "C" fn(vp: *mut ImGuiViewport)>,
    pub platform_set_window_pos: Option<extern "C" fn(vp: *mut ImGuiViewport, pos: ImVec2)>,
    pub platform_get_window_pos: Option<extern "C" fn(vp: *mut ImGuiViewport) -> ImVec2>,
    pub platform_set_window_size: Option<extern "C" fn(vp: *mut ImGuiViewport, size: ImVec2)>,
    pub platform_get_window_size: Option<extern "C" fn(vp: *mut ImGuiViewport) -> ImVec2>,
    pub platform_set_window_focus: Option<extern "C" fn(vp: *mut ImGuiViewport)>,
    pub platform_get_window_focus: Option<extern "C" fn(vp: *mut ImGuiViewport) -> bool>,
    pub platform_get_window_minimized: Option<extern "C" fn(vp: *mut ImGuiViewport) -> bool>,
    pub platform_set_window_title: Option<extern "C" fn(vp: *mut ImGuiViewport, title: *const c_char)>,
    pub platform_set_window_alpha: Option<extern "C" fn(vp: *mut ImGuiViewport, alpha: c_float)>,
    pub platform_update_window: Option<extern "C" fn(vp: *mut ImGuiViewport)>,
    pub platform_render_window: Option<extern "C" fn(vp: *mut ImGuiViewport, render_arg: *mut c_void)>,
    pub platform_swap_buffers: Option<extern "C" fn(vp: *mut ImGuiViewport, render_arg: *mut c_void)>,
    pub platform_get_window_dpi_scale: Option<extern "C" fn(vp: *mut ImGuiViewport) -> c_float>,
    pub platform_on_changed_viewport: Option<extern "C" fn(vp: *mut ImGuiViewport)>,
    pub platform_set_ime_input_pos: Option<extern "C" fn(vp: *mut ImGuiViewport, pos: ImVec2)>,
    pub platform_create_vk_surface: Option<extern "C" fn(vp: *mut ImGuiViewport, vk_inst: ImU64, vk_allocators: *const c_void, out_vk_surface: *mut ImU64) -> c_int>,
    pub renderer_create_window: Option<extern "C" fn(vp: *mut ImGuiViewport)>,
    pub renderer_destroy_window: Option<extern "C" fn(vp: *mut ImGuiViewport)>,
    pub renderer_set_window_size: Option<extern "C" fn(vp: *mut ImGuiViewport, size: ImVec2)>,
    pub renderer_render_window: Option<extern "C" fn(vp: *mut ImGuiViewport, render_arg: *mut c_void)>,
    pub renderer_swap_buffers: Option<extern "C" fn(vp: *mut ImGuiViewport, render_arg: *mut c_void)>,
    pub monitors: ImVector<ImGuiPlatformMonitor>,
    pub main_viewport: *mut ImGuiViewport,
...
pub struct ImGuiWindowClass {
    ...
    pub parent_viewport_id: ImGuiID,
    pub viewport_flags_override_mask: ImGuiViewportFlags,
    pub viewport_flags_override_value: ImGuiViewportFlags,
...
extern "C" {
    ...
    pub fn ImGuiIO_AddInputCharactersUTF8(this: *mut ImGuiIO, str: *const c_char);
...
extern "C" {
    ...
    pub fn ImGuiTextBuffer_append(this: *mut ImGuiTextBuffer, str: *const c_char, str_end: *const c_char);
...
// GlyphRangesBuilder
extern "C" {
    pub fn ImFontGlyphRangesBuilder_GetBit(this: *mut ImFontGlyphRangesBuilder, n: c_int) -> bool;
    pub fn ImFontGlyphRangesBuilder_SetBit(this: *mut ImFontGlyphRangesBuilder, n: c_int);
    pub fn ImFontGlyphRangesBuilder_AddChar(this: *mut ImFontGlyphRangesBuilder, c: ImWchar);
    pub fn ImFontGlyphRangesBuilder_AddText(
        this: *mut ImFontGlyphRangesBuilder,
        text: *const c_char,
        text_end: *const c_char,
    );
    pub fn ImFontGlyphRangesBuilder_AddRanges(this: *mut ImFontGlyphRangesBuilder, ranges: *const ImWchar);
