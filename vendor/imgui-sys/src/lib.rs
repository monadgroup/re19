...
extern "C" {
    ...
    pub fn igRenderPlatformWindowsDefault(platform_arg: *mut c_void, renderer_arg: *mut c_void);
    pub fn igDestroyPlatformWindows();
    pub fn igFindViewportById(id: ImGuiID) -> *mut ImGuiViewport;
    pub fn igFindViewportByPlatformHandle(platform_handle: *mut c_void) -> *mut ImGuiViewport;
}
...
extern "C" {
    ...
    pub fn igGetWindowDpiScale() -> c_float;
...
extern "C" {
    ...
    pub fn igSetScrollFromPosY(local_y: c_float, center_y_ratio: c_float);
}
...
extern "C" {
    ...
    pub fn igPushTextWrapPos(wrap_local_pos_x: c_float);
...
extern "C" {
    ...
    pub fn igSetCursorPosX(local_x: c_float);
    pub fn igSetCursorPosY(local_y: c_float);
...
extern "C" {
    ...
    pub fn igEndTabBar();
    pub fn igBeginTabItem(label: *const c_char, p_open: *mut bool, flags: ImGuiTabItemFlags) -> bool;
    pub fn igEndTabItem();
...
extern "C" {
    ...
    pub fn igDockSpaceOverViewport(viewport: *const ImGuiViewport, dockspace_flags: ImGuiDockNodeFlags, window_class: *const ImGuiWindowClass) -> ImGuiID;
...
extern "C" {
    ...
    pub fn igGetOverlayDrawListViewportPtr(viewport: *mut ImGuiViewport) -> *mut ImDrawList;
